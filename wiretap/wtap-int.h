 ...
 */
WS_DLL_PUBLIC
bool wtap_read_bytes_or_eof(FILE_T fh, void *buf, unsigned int count, int *err,
                            char **err_info);
 ...
 */
WS_DLL_PUBLIC
bool wtap_read_bytes(FILE_T fh, void *buf, unsigned int count, int *err,
                     char **err_info);
 ...
 */
WS_DLL_PUBLIC
bool wtap_read_packet_bytes(FILE_T fh, Buffer *buf, unsigned length, int *err,
                            char **err_info);
 ...
 */
WS_DLL_PUBLIC
bool wtap_full_file_read(wtap *wth, wtap_rec *rec, int *err, char **err_info,
                         int64_t *data_offset);
 ...
 * as a single packet.
 */
bool wtap_full_file_seek_read(wtap *wth, int64_t seek_off, wtap_rec *rec,
